...
#include <STL/fixed_tuple_vector.h>
...
int TestStlFixedTupleVectorVariant()
{
	int nErrorCount = 0;
...
int TestStlFixedTupleVector()
{
	...
	nErrorCount += TestStlFixedTupleVectorVariant<2, true>();
	nErrorCount += TestStlFixedTupleVectorVariant<16, true>();
	nErrorCount += TestStlFixedTupleVectorVariant<64, false>();
